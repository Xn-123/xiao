          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for=" spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" 
                :class="{active:spu.isChecked == '1'}" v-for="spu in spuSaleAttr.spuSaleAttrValueList" 
                :key="spu.id"
                @click="changeActive(spuSaleAttr.spuSaleAttrValueList,spu)">
...
<script>
  ...
  export default {
    ...
    methods: {
      // 选择性高亮
      changeActive(arr , SaleAttrValue ){
          arr.forEach(item => {
            item.isChecked = '0'
          });
